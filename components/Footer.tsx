...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white pt-16 md:pt-24 pb-12 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5 pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at 100% 100%, #2BBCB3 0, transparent 25%)' }}></div>
      ...
      >
        <button className="bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full p-4 shadow-2xl transition duration-300 transform hover:scale-110 hover:rotate-12 ring-4 ring-white/20">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-5.031 1.378c-3.055 2.08-5.006 5.057-5.006 8.309 0 5.357 4.372 9.72 9.728 9.72h.005c2.57 0 5.01-.682 7.14-1.974l5.119 1.34-.86-5.058c1.308-1.96 2.037-4.144 2.037-6.379 0-5.423-4.409-9.836-9.829-9.836z" />
          </svg>
        </button>
      </motion.div>
    </footer>
