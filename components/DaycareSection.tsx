...
const sectionContent: Record<ServiceSection, {
  ...
  daycare: {
    ...
    subtitle: 'بيئة متكاملة للرعاية والتأهيل',
    description: 'نقدم تجهيزات متكاملة لمراكز الرعاية النهارية تشمل التخطيط، التوريد، والتركيب لمسارات التخاطب والتكامل الحسي والعلاج الوظيفي والعلاج الطبيعي وفق متطلبات التشغيل المعتمدة.',
    note: 'نراعي في الحلول المعروضة اشتراطات وزارة الموارد البشرية والتنمية الاجتماعية الخاصة بمراكز الرعاية النهارية.',
    cta: 'اطلب تجهيز مركز رعاية نهارية',
    image: '/children-care.png',
    imageAlt: 'تجهيزات الرعاية النهارية',
    tracks: [
      'غرفة النطق',
      'غرفة العلاج الوظيفي',
      'غرفة التكامل الحسي',
